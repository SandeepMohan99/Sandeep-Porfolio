            ...
            <div className="container-custom relative z-10 py-12">
                        ...
                        <div className="flex gap-3">
                            {socialLinks.map((social) => (
                                <motion.a
                                    ...
                                    whileTap={{ scale: 0.95 }}
                                    className="w-10 h-10 glass rounded-lg flex items-center justify-center hover:bg-white/15 transition-all group"
                ...
                >
                    <p className="text-slate-500 text-sm">
                        © {currentYear} <span className="text-gradient-primary font-semibold">Sandeep A M</span>. All rights reserved.
                    </p>
