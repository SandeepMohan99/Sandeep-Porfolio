            ...
            <div className="max-w-7xl w-full relative z-10">
                <div className="flex flex-col items-center text-center space-y-8">
                    ...
                    <motion.h1
                        ...
                        className="text-6xl md:text-7xl lg:text-8xl font-bold font-heading leading-tight"
                    >
                    ...
                    >
                        {['React', 'Next.js', 'TypeScript', 'Node.js', 'Express.js', 'REST APIs', 'MongoDB'].map((tech, index) => (
                            <motion.span
                                key={tech}
                                ...
                                className="px-4 py-2 glass rounded-xl text-sm font-medium text-white hover:bg-white/15 transition-all cursor-default"
                            >
                                {tech}
                            </motion.span>
                        ))}
